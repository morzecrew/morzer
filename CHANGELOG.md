...
- Command-line manager for the lifecycle of a self-hosted product on a single Linux machine running Docker Compose. Provides init, apply, status, doctor, backup, restore, secret and release commands.
