...
- **P2 — Manifest and state.** 🚧 **Partly shipped 2026-08-16.** `runtimes:` map,
  ...
  work (logs/wave-27.md (D-016)), and the deprecation of `runtime:`, which has no
  ...
  against RFC 0018's mechanism, logs/wave-29.md (D-023). **No longer gated on P1b** — decided 2026-08-16, see
  logs/wave-25.md (D-005). None of §12's three measurements is consumed by anything on this list:
  ...
  host work itself, recorded in §11 and logs/wave-25.md (D-006); none of them is
...
2026-08-16 — see logs/wave-25.md (D-005) and §10's P2 bullet. Item 4 gates P3,
...
downstream, and never attacked. Added by execution 2026-08-19 -- see logs/wave-34.md (D-052).
...
firing. Added by execution 2026-08-17 — see logs/wave-30.md (D-024).
...
rows in logs/wave-25.md: **D-001, D-002, D-003 and D-006, all outstanding.**
...
author as logs/wave-25.md (D-005) and accepted; the phasing prose in §10 and §12
...
described — see logs/wave-27.md (D-016), outstanding.
...
no adapter for. Put to the author as logs/wave-27.md (D-015) and accepted:
